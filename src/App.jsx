...
function App() {
  ...
  return (
    <div className="min-h-screen bg-stone-950 flex items-center justify-center p-4 font-serif">
      <div className="max-w-5xl w-full">
        <h1 className="text-4xl md:text-5xl text-center text-stone-200 mb-12 font-bold tracking-wider">
          选择你的命运
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div
            ...
            className="group relative h-[500px] rounded-xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-rose-900/20 border border-stone-800"
          >
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end">
              <div className="mb-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <h2 className="text-3xl font-bold text-stone-100 mb-2">凤鸣九霄</h2>
          ...
          <div
            ...
            className="group relative h-[500px] rounded-xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-cyan-900/20 border border-stone-800"
          >
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end">
              <div className="mb-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <h2 className="text-3xl font-bold text-slate-100 mb-2">冰封之心</h2>
