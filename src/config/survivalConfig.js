...
这一天，世界没有迎来圣诞的钟声，而是听到了文明崩塌的脆响。

史无前例的极端寒潮如恶魔般席卷全球，气温在短短24小时内骤降至零下60度。繁华的都市瞬间化为冰封的坟墓，电力中断，通讯瘫痪，人类引以为傲的现代文明在绝对的严寒面前不堪一击。

你叫林暮雪，国家气象研究所的一名助理研究员。

此刻，你正艰难地跋涉在一片白茫茫的荒原之上。这里曾经是繁华的商业区，如今只剩下露出雪面的半截路灯和被冰雪覆盖的车辆残骸，像是一座座沉默的墓碑。

狂风呼啸，卷起漫天雪粉，如刀割般刮过你早已失去知觉的脸颊。你的眉毛、睫毛上结满了厚厚的冰霜，每一次呼吸都伴随着肺部撕裂般的疼痛。

你的怀里死死抱着一个黑色的防水包，里面装着一块硬盘——那是导师在生命最后一刻托付给你的。

"暮雪，带着它走...这是人类最后的希望..." 导师推开你的手，将自己反锁在即将崩塌的实验室里的画面，一遍遍在你脑海中回放。

为了这块硬盘，你已经独自在风雪中行走了整整两天。

体温在一点点流逝，双腿像灌了铅一样沉重。饥饿、寒冷、疲惫，像无数只无形的手，试图将你拖入永恒的黑暗。

"不行...不能倒在这里..." 你咬破舌尖，试图用疼痛唤醒濒临涣散的意识。

突然，脚下一空，你重重地摔倒在雪地里。冰冷的雪沫灌进领口，带走了最后一丝余温。

视线开始模糊，世界逐渐变成一片死寂的灰白。

就在你以为一切都要结束的时候，风雪深处，隐约出现了一个模糊的人影。那人影似乎正向着你的方向移动，在这绝望的白色地狱中，显得如此不真实。

是幻觉吗？还是...死神来临前的仁慈？

[OPTIONS: 拼尽全力呼救 | 警惕地观察不动 | 挣扎着试图站起]
[PROGRESS: +0]`;
